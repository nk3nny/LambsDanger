...
switch (_mode) do {
    ...
    case "init": {
        ...
        if (_isCuratorPlaced) then {
            ...
            if (isNull _group) then {
                ...
                [LSTRING(Module_TaskAssault_DisplayName),
                    [
                        ...
                        [LSTRING(Module_TaskAssault_Retreating_DisplayName), "BOOLEAN", LSTRING(Module_TaskAssault_Retreating_Tooltip), TASK_ASSAULT_ISREATREAT],
                        [LSTRING(Module_TaskAssault_DistanceThreshold_DisplayName), "SLIDER", LSTRING(Module_TaskAssault_DistanceThreshold_Tooltip), [1, 100], [2, 1], TASK_ASSAULT_DISTANCETHREASHOLD, 2],
            ...
            private _retreat = _logic getVariable [QGVAR(IsRetreat), TASK_ASSAULT_ISREATREAT];
            private _deleteAfterStartup = _logic getVariable [QGVAR(DeleteOnStartUp), TASK_ASSAULT_DELETEONSTARTUP];
            private _threshold = _logic getVariable [QGVAR(DistanceThreshold), TASK_ASSAULT_DISTANCETHREASHOLD];
