            ...
            if (isNull _group) then {
                ...
                [LSTRING(Module_TaskAssault_DisplayName),
                    [
                        ...
                        [LSTRING(Module_TaskAssault_DistanceThreshold_DisplayName), "NUMBER", LSTRING(Module_TaskAssault_DistanceThreshold_Tooltip), [1, 100], [1, 2], 15],
                        [LSTRING(Module_TaskAssault_CycleTime_DisplayName), "NUMBER", LSTRING(Module_TaskAssault_CycleTime_Tooltip), [1, 300], [0.5, 1], 3],
