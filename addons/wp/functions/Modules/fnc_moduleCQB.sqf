            ...
            if (isNull _group) then {
                ...
                [LSTRING(Module_TaskCQB_DisplayName),
                    [
                        ...
                        [LSTRING(Module_TaskCQB_Radius_DisplayName), "NUMBER", LSTRING(Module_TaskCQB_Radius_ToolTip), [10, 500], [1, 2], 50],
                        [LSTRING(Module_TaskCQB_CycleTime_DisplayName), "NUMBER", LSTRING(Module_TaskCQB_CycleTime_Tooltip), [1, 300], [0.5, 1], 21],
