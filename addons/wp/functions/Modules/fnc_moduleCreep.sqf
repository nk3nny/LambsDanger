        ...
        if (_isCuratorPlaced) then {
            ...
            if (_error == "") then {
                [LSTRING(Module_TaskCreep_DisplayName),
                    [
                        [LSTRING(Module_TaskCreep_Radius_DisplayName), "SLIDER", LSTRING(Module_TaskCreep_Radius_ToolTip), [25,5000], [0.5, 1], 1000],
                        [LSTRING(Module_TaskCreep_CycleTime_DisplayName), "SLIDER", LSTRING(Module_TaskCreep_CycleTime_ToolTip), [1, 300], [0.5, 1], 15],
