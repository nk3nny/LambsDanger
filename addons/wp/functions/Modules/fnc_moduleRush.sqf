        ...
        if (_isCuratorPlaced) then {
            ...
            if (_error == "") then {
                [LSTRING(Module_TaskRush_DisplayName),
                    [
                        [LSTRING(Module_TaskRush_Radius_DisplayName), "SLIDER", LSTRING(Module_TaskRush_Radius_ToolTip), [25,5000], [0.5, 1], 1000],
                        [LSTRING(Module_TaskRush_CycleTime_DisplayName), "SLIDER", LSTRING(Module_TaskRush_CycleTime_ToolTip), [1, 300], [0.5, 1], 4],
