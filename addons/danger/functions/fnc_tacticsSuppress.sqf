...
// adjust pos
private _vis = lineIntersectsSurfaces [(eyePos _unit) vectorAdd [0, 0, 15], _targetASL vectorAdd [0, 0, 2.5], _unit, objNull, true, 1, "GEOM", "VIEW"];
if (_vis isNotEqualTo [] && {((_vis select 0) select 0) vectorDistance _targetASL > 143}) exitWith {
